...
// */
//public class ThreeWiseConfigurationGenerator extends AbstractAnalysis<List<List<String>>> {
//
...
//
//	public ThreeWiseConfigurationGenerator(SatInstance satInstance, int maxNumber) {
//		super(satInstance);
