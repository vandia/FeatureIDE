...
public class FGBuilder extends AbstractAnalysis<IFeatureGraph> {
	...
	public FGBuilder(ISatSolver2 solver) {
		super(solver);
	}

	public FGBuilder(CNF satInstance) {
		super(satInstance);
	}
	...
	public IFeatureGraph analyze(IMonitor monitor) throws Exception {
		...
		solver.useSolutionList(Integer.MAX_VALUE);
		...
		if (model1 != null) {
			...
			outer: for (LiteralSet clause : satInstance.getClauses()) {
