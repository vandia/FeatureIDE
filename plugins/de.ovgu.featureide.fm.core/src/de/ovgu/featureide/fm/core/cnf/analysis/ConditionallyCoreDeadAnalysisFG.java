...
public class ConditionallyCoreDeadAnalysisFG extends AConditionallyCoreDeadAnalysis {
	...
	public ConditionallyCoreDeadAnalysisFG(ISatSolver2 solver, IFeatureGraph featureGraph) {
		super(solver);
		this.featureGraph = featureGraph;
	}

	public ConditionallyCoreDeadAnalysisFG(CNF satInstance, IFeatureGraph featureGraph) {
		super(satInstance);
		this.featureGraph = featureGraph;
	}
...
//			satCount++;
			...
			for (int i = 0; i < newCount; i++) {
				int var = assumptions.getLiterals()[i];
